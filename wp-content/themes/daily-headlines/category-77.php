...
<div id="content">
    <div class="wrap">
      ...
      <div id="image-blogue"><img src="http://www.faitsetcauses.com/wp-content/uploads/2013/05/alexandra-parent2.png" /> </div>
		<h2 id="titre-blogue"><?php single_cat_title(); ?></h2>
	  <?php /* AJOUT DE TEXT EN HAUT DE PAGE SELON LA CATEGORIE */ ?>
	  <?php if(is_category( '' )) {
		echo "";
	  } ?>	
      
      <p align="right"><p margin=""><a href="https://twitter.com/alexandraparent" class="twitter-follow-button" data-show-count="false" data-lang="fr">Suivre @alexandraparent</a>
