...
?>
  ...
  <div id="footer">
    ...
    <div class="wrap">
        ...
        <p>&copy; <?php echo date("Y",time()); ?> <?php echo "Faits et Causes"; ?>. Tous droits réservés. | Les textes publiés sur le site Faits et Causes n'engagent que leurs auteurs et ne sont pas des opinions juridiques. </p>
