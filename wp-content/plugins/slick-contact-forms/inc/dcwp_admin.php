			  ...
			  <fieldset>
			    <ol>
				  ...
				  <li class="input-row">
					...
					<input class="<?php echo $this->dcscf_validation($widget_options['valid1'], 'defaultText text-input'); ?>" id="input1" name="input1" value="" title="<?php echo $label1; ?>" />
				  ...
				  <li class="input-row">	
					...
					<input class="<?php echo $this->dcscf_validation($widget_options['valid2'], 'defaultText text-input'); ?>" id="input2" name="input2" value="" title="<?php echo $label2; ?>" />
				  ...
				  <li class="input-row">	
					...
					<input class="<?php echo $this->dcscf_validation($widget_options['valid3'], 'defaultText text-input'); ?>" id="input3" name="input3" value="" title="<?php echo $label3; ?>" />
					<input type="hidden" name="valid3" value="<?php echo $valid3; ?>" />
				  </li>
				  <?php } ?>
				  <?php if($validText > '-1'){ ?>
				  <li class="text-row">	
				    <label for="dcscf-comments"><?php echo $labelText; ?></label>
					<textarea id="dcscf-comments" name="comments" class="<?php echo $this->dcscf_validation($widget_options['validText'], 'defaultText text-area'); ?>" rows="6" title="<?php echo $labelText; ?>"></textarea>
				  </li>
				  <?php } ?>
				  <li class="nocomment">
			...
			<script type="text/javascript">
				jQuery(document).ready(function($){
					...
					if(!jQuery().dcSlickContact) {
						$.getScript("<?php echo dc_jqslickcontact::get_plugin_directory() . '/js/jquery.slick.contact.1.3.2.js'; ?>", function(){
							jQuery('#<?php echo $widget_id.'-item'; ?>').dcSlickContact(config);
						}); 
					} else {
						jQuery('#<?php echo $widget_id.'-item'; ?>').dcSlickContact(config);
					}
